...
class TestGTOPO30:
    ...
    def test_gtopo30_init(self, temp_dir):
        ...
        processor = GTOPO30(lat=(45.0, 47.0), lon=(5.0, 7.0), directory=str(temp_dir), missing=-999)
    ...
    def test_gtopo30_method_linear(self, temp_dir):
        ...
        processor = GTOPO30(lat=(45.0, 47.0), lon=(5.0, 7.0), directory=str(temp_dir), method='linear')
    ...
    def test_gtopo30_invalid_method(self, temp_dir):
        ...
        with pytest.raises(ValueError):
            GTOPO30(lat=(45.0, 47.0), lon=(5.0, 7.0), directory=str(temp_dir), method='invalid')
